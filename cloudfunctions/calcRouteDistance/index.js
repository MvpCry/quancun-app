...
exports.main = async (event, context) => {
  ...
  try {
    ...
    if (attractions.length < 2) {
      ...
      return { success: true, totalDistance: 0, estimatedTime: 0, message: '景点不足2个，距离为0' };
    }
    ...
    // 预估时长：乡村道路平均 40km/h，每个景点停留 45 分钟
    var driveHours = totalDistance / 40;
    var stopHours = validStops.length * 0.75;
    var estimatedTime = Math.round((driveHours + stopHours) * 10) / 10;
